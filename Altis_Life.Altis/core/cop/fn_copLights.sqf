...
*/
Private ["_vehicle","_lightRed","_lightBlue","_lightleft","_lightright","_leftBlue"];
...
switch (typeOf _vehicle) do
{
	...
	{
		_lightleft lightAttachObject [_vehicle, [-1.35, -3.1, -0.16]];
	};
};
...
switch (typeOf _vehicle) do
{
	...
	case "B_APC_Tracked_01_CRV_F":
	{
		_lightright lightAttachObject [_vehicle, [1.35, -3.1, -0.16]];
	};
};
