...
//Gang related stuff?
__CONST__(life_gangPrice,125000); //Price for creating a gang (They're all persistent so keep it high to avoid 345345345 gangs).
...
[
	...
	["C_Hatchback_01_sport_F",00],
	["C_Van_01_fuel_F",00],
	["I_Heli_Transport_02_F",00],
	["C_Van_01_box_F",00],
	["I_Truck_02_transport00_F",0],
