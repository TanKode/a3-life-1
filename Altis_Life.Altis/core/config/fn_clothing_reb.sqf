...
switch (_filter) do
{
	...
	case 1:
	{
		[
			...
			["H_CrewHelmetHeli_O",nil,2500],
			["H_HelmetB_light_black",nil,4500],
			["H_HelmetLeaderO_oucamo",nil,4500],
			["H_HelmetB_camo",nil,4500]
		];
	};
	...
	case 3:
	{
		[
			...
			["V_PlateCarrierGL_blk",nil,75000],
			["V_PlateCarrierGL_mtp",nil,75000],
			["V_PlateCarrierIAGL_oli",nil,75000],
