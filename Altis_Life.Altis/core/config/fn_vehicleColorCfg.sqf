...
switch (_vehicle) do
{
	...
	case "B_MRAP_01_F":
	{
		...
		[
			...
			[_path + "hunter_notarzt_front2.paa","med",_path + "hunter_notarzt_hinten2.paa"]
		];
	};
	...
	case "O_MRAP_02_F":
	{
		...
		[
			...
			[_path + "taliban_1.jpg","civ",_path + "taliban_2.jpg"],
			["\A3\Soft_F\MRAP_02\data\mrap_02_ext_01_co.paa","civ","\A3\Soft_F\MRAP_02\data\mrap_02_ext_02_co.paa"],
			[_path + "ifrit_medic_01.jpg","med",_path + "ifrit_medic_02.jpg"]
		];
	};
