...
_type = _queryResult select 0;
{
	switch(_x) do
	{
		...
		case "261": {_x = "STR_Crime_261"};
		case "261A": {_x = "STR_Crime_261A"};
		case "215": {_x = "STR_Crime_215"};
		case "213": {_x = "STR_Crime_213"};
		case "211": {_x = "STR_Crime_211"};
		case "411A": {_x = "STR_Crime_411A"};
		case "46A": {_x = "STR_Crime_46A"};
		...
		case "42A": {_x = "STR_Crime_42A"};
		case "43A": {_x = "STR_Crime_43A"};
		case "800": {_x = "STR_Crime_800"};
		case "459": {_x = "STR_Crime_459"};
		case "460": {_x = "STR_Crime_460"};
		case "919": {_x = "STR_Crime_919"};
		case "390": {_x = "STR_Crime_390"};
		case "902": {_x = "STR_Crime_902"};
		case "903": {_x = "STR_Crime_903"};
		case "customtype": {_x = "STR_Crime_customtype"};
		case "weapon": {_x = "STR_Crime_weapon"};
		case "policeitems": {_x = "STR_Crime_policeitems"};
        ...
        case "120H": {_x = "STR_Crime_120H"};
        case "120FS": {_x = "STR_Crime_120FS"};
        case "120S": {_x = "STR_Crime_120S"};
        case "120FSWL": {_x = "STR_Crime_120FSWL"};
		
		case "240": {_x = "STR_Crime_240"};
	};
