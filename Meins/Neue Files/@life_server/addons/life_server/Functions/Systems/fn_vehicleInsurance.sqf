...
if(count _dbInfo > 0) then {
	//_query = format["UPDATE vehicles SET alive='1', active = '0', damage='0' WHERE pid='%1' AND plate='%2'",_uid,_plate];
	_query = format["VehicleUpdateInsurance:1:0:0:%1:%2",_uid,_plate];
