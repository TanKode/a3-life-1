...
switch(_mode) do {
	case 0: {
		...
		switch(_side) do {
			case west: {_query = format["playerUpdateCopCash:%1:%2",_value,_uid];};
			case civilian: {_query = format["playerUpdateCash:%1:%2",_value,_uid];};
			case independent: {_query = format["playerUpdateMedCash:%1:%2",_value,_uid];};
			case east: {_query = format["playerUpdateAdacCash:%1:%2",_value,_uid];};
		};
	};
	...
	case 1: {
		...
		_value = [_value] call DB_fnc_numberSafe;
		switch(_side) do {
			case west: {_query = format["playerUpdateCopBank:%1:%2",_value,_uid];};
			case civilian: {_query = format["playerUpdateBank:%1:%2",_value,_uid];};
			case independent: {_query = format["playerUpdateMedBank:%1:%2",_value,_uid];};
			case east: {_query = format["playerUpdateAdacBank:%1:%2",_value,_uid];};
		};
	};
	...
	case 6: {
		...
		switch(_side) do {
			case west: {_query = format["playerUpdateCopBank+Cash:%1:%2:%3",_value1,_value2,_uid];};
			case civilian: {_query = format["playerUpdateBank+Cash:%1:%2:%3",_value1,_value2,_uid];};
			case independent: {_query = format["playerUpdateMedBank+Cash:%1:%2:%3",_value1,_value2,_uid];};
			case east: {_query = format["playerUpdateAdacBank+Cash:%1:%2:%3",_value1,_value2,_uid];};
		};
	};
