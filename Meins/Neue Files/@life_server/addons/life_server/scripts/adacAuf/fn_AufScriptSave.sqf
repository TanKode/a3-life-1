...
fnc_AufFuncs = {
    ...
    life_aufList = ["aufBuchMenu","auftragsBuch","showAuftraege","aufMarker","meineAuftraege","deleteAuftraege","newAuftraege","aufRequest","mapZoomIn"];
...
["fnc_AufFuncs"] call fnc_compileFinal;
publicVariable "fnc_AufFuncs";
