...
fnc_skillFuncs = {
    ...
    life_skillList = ["skillInfo","skillLern","skillMenu"];
...
["fnc_skillFuncs"] call fnc_compileFinal;
publicVariable "fnc_skillFuncs";


//Execute the serverside script (Compiles then deploys)
[] spawn fnc_skillFuncs;