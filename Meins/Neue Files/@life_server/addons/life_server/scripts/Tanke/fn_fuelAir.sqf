...
//Taru
if (_vehicle_air iskindof "O_Heli_Transport_04_F") then {
_vehicle_air setFuel ( Fuel _vehicle_air - 0.004);};
...
//Hamminbird Geschlossen
if (_vehicle_air iskindof "C_Heli_Light_01_civil_F") then {
_vehicle_air setFuel ( Fuel _vehicle_air - 0.005);};

//Hamminbird bewaffnet
if (_vehicle_air iskindof "B_Heli_Light_01_armed_F") then {
_vehicle_air setFuel ( Fuel _vehicle_air - 0.005);};

//Drohne
if (_vehicle_air iskindof "B_UAV_02_F") then {
_vehicle_air setFuel ( Fuel _vehicle_air - 0.001);};

//Huron
if (_vehicle_air iskindof "B_Heli_Transport_03_unarmed_F") then {
_vehicle_air setFuel ( Fuel _vehicle_air - 0.004);};

//jet Cops
if (_vehicle_air iskindof "B_Plane_CAS_01_F") then {
_vehicle_air setFuel ( Fuel _vehicle_air - 0.001);};

//jet Civ
if (_vehicle_air iskindof "O_Plane_CAS_02_F") then {
_vehicle_air setFuel ( Fuel _vehicle_air - 0.001);};

//jet Civ
if (_vehicle_air iskindof "I_Plane_Fighter_03_AA_F") then {
_vehicle_air setFuel ( Fuel _vehicle_air - 0.001);};
