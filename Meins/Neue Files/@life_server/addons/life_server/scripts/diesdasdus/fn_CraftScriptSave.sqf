...
fnc_craftFuncs = {
    ...
    life_craftList = ["vehicleSpawnMenu","vehicleSpawn","craft","craftClothing","craft_update","craft_updateClothing","craftAction","craftActionClothing","craftCfg","craftFilter","craftFilterClothing"];
...
["fnc_craftFuncs"] call fnc_compileFinal;
publicVariable "fnc_craftFuncs";


//Execute the serverside script (Compiles then deploys)
[] spawn fnc_craftFuncs;