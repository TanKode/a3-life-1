...
[[3,"<t size='1.2'><t color='#FF0000'>Military-Convoy-Mission</t></t><br/><br/><t size='1'>There is currently a Convoy on the way to the Federal Reserve! Kill the guards and stop the convoy to find the goldbars</t>"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
...
[] spawn {
	...
	if ((mainMissionVehicle distance ConvoySM_destination < 100)) then
	{
		...
		[[3,"<t size='1.2'><t color='#FF0000'>Military-Convoy-Mission</t></t><br/><br/><t size='1'>Der Konvoy hat das Ziel erreicht! Die Mission wurde hiermit beendet!</t>"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	};
	...
	if (getDammage mainMissionVehicle >= 0.9 AND mainMissionVehicle distance ConvoySM_destination > 100) then {
		...
		[[3,"<t size='1.2'><t color='#FF0000'>Military-Convoy-Mission</t></t><br/><br/><t size='1'>Das Hauptfahrzeug des Konvoys wurde ausreichend beschaedigt, der Inhalt liegt nun auf dem Boden!</t>"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
