...
fnc_TaruFuncs = {
    ...
    life_TaruList = ["Taru","TaruArrimerPod","TaruDesarrimePod","TaruLarguerPod","ListeJoueur","TransmissionSonMessage","TaruGetIn","TaruHotfixVRotor"];
...
["fnc_TaruFuncs"] call fnc_compileFinal;
publicVariable "fnc_TaruFuncs";
