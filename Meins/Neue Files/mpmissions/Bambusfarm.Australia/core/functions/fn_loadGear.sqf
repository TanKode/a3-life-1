...
_launcher = [_itemArray,7,"",[""]] call BIS_fnc_param;
_seco = [_itemArray,8,"",[""]] call BIS_fnc_param;
...
life_hunger = [_itemArray,19,100,[0]] call BIS_fnc_param;
life_thirst = [_itemArray,20,100,[0]] call BIS_fnc_param;
life_battery = [_itemArray,21,100,[0]] call BIS_fnc_param;
_damage = [_itemArray,22,0,[0]] call BIS_fnc_param;
