...
else
{
    ...
    [[getPlayerUID player,profileName,"43A"],"life_fnc_wantedAdd",false,false] spawn life_fnc_MP;
    [[0,format["%1 wurde dabei gesehen wie er eine Radarfalle hacken wollte.", name player]],"life_fnc_broadcast",west,false] spawn life_fnc_MP;
