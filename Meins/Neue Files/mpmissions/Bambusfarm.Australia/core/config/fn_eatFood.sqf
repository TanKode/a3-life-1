...
if([false,_food,1] call life_fnc_handleInv) then {
	...
	{
		case "apple": {_val = 10};
		case "rabbit_grilled": { _val = 50};
        case "sheep_grilled": { _val = 50};
        case "rooster_grilled": { _val = 45};       
        case "goat_grilled": { _val = 50};
		case "hueners": {_val = 50};
		case "eieromlet": {_val = 40};
		case "salema": {_val = 30};
		case "ornate": {_val = 25};
