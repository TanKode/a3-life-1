...
{	
	...
	if(player distance _vehicle > 10) exitWith {hint localize "STR_NOTF_KonfisCancelled"; life_action_inUse = false;_ui = "osefStatusBar" call BIS_fnc_rscLayer;_ui cutRsc["osefStatusBar","PLAIN"];};
