...
switch (_ziel) do
{
	case "Athira": {_cash = 12200; _time1 = (2*60); _time2 = (3 * 60);};
	case "Airport": {_cash = 13400; _time1 = (2*60); _time2 = (3 * 60);};
	case "Kavala": {_cash = 9100; _time1 = (2*60); _time2 = (2 * 60);};
	case "Sofia": {_cash = 23500; _time1 = (2*60); _time2 = (5 * 60);};
	case "Pyrgos": {_cash = 17400; _time1 = (2*60); _time2 = (4 * 60);};
