...
switch (_ziel) do
{
	case "Athira": {_cash = 2100; _time1 = (2*60); _time2 = (1 * 60);};
	case "Kavala": {_cash = 11600; _time1 = (2*60); _time2 = (3 * 60);};
	case "Pyrgos": {_cash = 4800; _time1 = (2*60); _time2 = (1 * 60);};
	case "Sofia": {_cash = 12200; _time1 = (2*60); _time2 = (3 * 60);};
