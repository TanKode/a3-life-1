...
MDET_fnc_playSound = {
	...
	switch (true) do {
		case (_percentage > 80 && _percentage < 100): { playSound "Mine1" };
		case (_percentage > 60 && _percentage < 80): { playSound "Mine2" };
		case (_percentage > 40 && _percentage < 60): { playSound "Mine3" };
		case (_percentage > 20 && _percentage < 40): { playSound "Mine4" };
		case (_percentage > 0  && _percentage < 20): { playSound "Mine5" };
	};
};
