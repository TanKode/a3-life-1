...
/// COMMON VARIABLES
if (isNil "MDET_var_radius") then { MDET_var_radius = 20 }; // Maximum distance from player to mine
if (isNil "MDET_var_angle") then { MDET_var_angle = 120 }; // Player to mine direction angle threshold
...
/// LOAD FUNCTIONS
call compile preprocessFileLineNumbers "scripts\MineDetector\functions.sqf";
