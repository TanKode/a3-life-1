...
class playerSettings {
	...
	class controls {
		...
		*/
		...
		class ADACAuftraege : Life_RscButtonMenu {
			idc = 2013;
			text = "Auftragsbuch";
			//onButtonClick = "hint ""Hier entsteht das Auftragsbuch des ADAC´s =)!""";
		...
		class ButtonWandetList : Life_RscButtonMenu {
			idc = 2012;
		...
		class ButtonCraftClothing : Life_RscButtonMenu {
			idc = 2026;
			text = "$STR_PM_CraftClothing";
		...
		class ButtonCallTaxi : life_RscButtonMenu {
			idc = -1;
			//shortcuts[] = {0x00050000 + 2};
			text = "CALL TAXI";
