...
_unit getVariable["realname",name _unit],[_ret select 0] call bambusfarm_fnc_numberText,[_ret select 1] call bambusfarm_fnc_numberText, _uni,_vest,_bp,_prim,_sec,_attach];