...
_door = [_house] call bambusfarm_fnc_nearestDoor;
...
[[2,"STR_House_Raid_NOTF",true,[(_house getVariable "house_owner") select 1]],"bambusfarm_fnc_broadcast",true,false] spawn bambusfarm_fnc_MP;
