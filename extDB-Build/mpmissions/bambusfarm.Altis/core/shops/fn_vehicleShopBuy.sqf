...
if(life_TASCHENGELD < _basePrice) exitWith {hint format[localize "STR_Shop_Veh_NotEnough",[_basePrice - life_TASCHENGELD] call life_fnc_numberText];};
...
life_TASCHENGELD = life_TASCHENGELD - _basePrice;
