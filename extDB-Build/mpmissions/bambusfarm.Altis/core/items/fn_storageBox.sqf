...
if(!(_house in bambusfarm_vehicles)) exitWith {hint localize "STR_ISTR_Box_NotinHouse"};
...
if(!([false,_boxType,1] call bambusfarm_fnc_handleInv)) exitWith {};
switch (_boxType) do {
	case "storagesmall": {
		...
		[[_house],"TON_fnc_updateHouseContainers",false,false] spawn bambusfarm_fnc_MP;
