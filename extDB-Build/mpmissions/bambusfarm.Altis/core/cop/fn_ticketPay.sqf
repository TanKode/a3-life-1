...
if(life_TASCHENGELD < life_ticket_val) exitWith
{
	if(life_BANK < life_ticket_val) exitWith
	{
	...
	life_BANK = life_BANK - life_ticket_val;
...
life_TASCHENGELD = life_TASCHENGELD - life_ticket_val;
life_ticket_paid = true;
