...
_RANDHACKMONEY = [3500,250000] call life_fnc_randomRound; // GELD was erhackt wurde
...
//
			...
			if(_chancetohackATM > 65) then 
			{
				...
				life_BANK = life_BANK + _RANDHACKMONEY;
				...
				if(_chanceWantedAdd < 65) then {
					...
					[[getPlayerUID player,name player,"1002"],"life_fnc_wantedAdd",false,false] spawn life_fnc_MP;
			...
			// Das wars für den Hacker!
						...
						[[getPlayerUID player,name player,"1003"],"life_fnc_wantedAdd",false,false] spawn life_fnc_MP;
