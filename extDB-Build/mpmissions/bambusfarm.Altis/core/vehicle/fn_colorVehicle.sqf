...
if(local _vehicle) then {
	...
	{
		case "C_Offroad_01_F": {[[_vehicle,"color",3,true],"TON_fnc_setObjVar",false,false] spawn bambusfarm_fnc_MP;};
		case "C_Hatchback_01_F": {[[_vehicle,"color",1,true],"TON_fnc_setObjVar",false,false] spawn bambusfarm_fnc_MP;};
		case "C_Hatchback_01_sport_F": {[[_vehicle,"color",1,true],"TON_fnc_setObjVar",false,false] spawn bambusfarm_fnc_MP;};
		case "C_SUV_01_F": {[[_vehicle,"color",1,true],"TON_fnc_setObjVar",false,false] spawn bambusfarm_fnc_MP;};
		case "C_Van_01_box_F": {[[_vehicle,"color",1,true],"TON_fnc_setObjVar",false,false] spawn bambusfarm_fnc_MP;};
		case "C_Van_01_transport_F": {[[_vehicle,"color",1,true],"TON_fnc_setObjVar",false,false] spawn bambusfarm_fnc_MP;};
	};
};

//Fetch texture from our present array.
_texture = [(typeOf _vehicle)] call bambusfarm_fnc_vehicleColorCfg;
...
if(local _vehicle) then
{
	_vehicle setVariable["bambusfarm_VEH_color",_index,true];
};
