...
switch (_var) do
{
	...
	case "life_inv_aktie_FUX": {"FUX Aktie(n)"};
	case "life_inv_aktie_windoof": {"Windoof Aktie(n)"};
	case "life_inv_aktie_doller": {"EUR/USD Aktie(n)"};
	case "life_inv_aktie_oel": {"Oel Aktie(n)"};
	case "life_inv_aktie_linux": {"Linux Aktie(n)"};
	case "life_inv_aktie_gold": {"Gold Aktie(n)"};
	case "life_inv_aktie_kupfer": {"Kupfer Aktie(n)"};
	case "life_inv_aktie_facebak": {"Facebak Aktie(n)"};
	case "life_inv_aktie_altis": {"Altis Aktie(n)"};
	case "life_inv_aktie_stratis": {"Stratis Aktie(n)"};
	case "life_inv_handcuffs": {"Handfesseln"};
	...
	case "license_civ_peach": {"Pfirsichlizenz"};
	case "license_civ_apple": {"Apfellizenz"};
