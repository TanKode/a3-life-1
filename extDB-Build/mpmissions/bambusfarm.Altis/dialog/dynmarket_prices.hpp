class bambusfarm_dynmarket_prices {
	idd = 7100;
	name= "bambusfarm_dynmarket_prices";
	movingEnable = false;
	enableSimulation = true;
	onLoad = "[] spawn {sleep 1;[] call bambusfarm_fnc_LoadIntoListbox;};";
...
{
	idc = 7055;
	onLBSelChanged = "[] spawn {[] call bambusfarm_fnc_DisplayPrices;};";
...
class RscText_1007: bambusfarm_RscStructuredText
{
	idc = 7058;
