...
if(_val > life_BANK) exitWith {hint localize "STR_ATM_NotEnoughFunds"};
if(_val < 100 && life_BANK > 20000000) exitWith {hint localize "STR_ATM_WithdrawMin"}; //Temp fix for something.
