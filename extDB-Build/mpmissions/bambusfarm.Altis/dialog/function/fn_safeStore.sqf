...
if(_num > bambusfarm_inv_goldbar) exitWith {hint format[localize "STR_Cop_NotEnoughGold",_num];};

//Store it.
if(!([false,_ctrl,_num] call bambusfarm_fnc_handleInv)) exitWith {hint localize "STR_Cop_CantRemove";};
