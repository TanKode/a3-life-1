//::::::::::::  ::::::::::::\\
//	Filename: bambusfarm_server/Functions/bambusfarm/fn_bambusfarm_GWH.sqf
...
private["_Weapons","_WpnItems","_Magazines","_Items","_AssignedItems","_Uniform","_Goggles","_Headgear","_Backpack","_Vest","_Pos","_GWH","_ItemCount","_GWHD"];
	...
	_GWH = "Box_NATO_Wps_F" createVehicle _Pos;
	...
	{if(_x == "")exitWith{}; _GWH addItemCargoGlobal _x;}forEach _WpnItems;
	...
	sleep 600;
	_GWHD = getPos _GWH nearestObject "Box_NATO_Wps_F";
	deleteVehicle _GWHD;