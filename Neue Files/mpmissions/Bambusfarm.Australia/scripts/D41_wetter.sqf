				...
				if(D41_ChanceN <= 5) then
					{
						...
						if(D41_WMod == 0)	then {D41_Nebel = [0.5, 0.1,10];		D41_Regen = 0;	D41_Vorschau = 0.4; D41_Blitze = 0;}; //Dicht
						if(D41_WMod == 1)	then {D41_Nebel = [0.5, 0.2,10];		D41_Regen = 0;	D41_Vorschau = 0.3; D41_Blitze = 0;};
						if(D41_WMod == 2)	then {D41_Nebel = [0.5, 0.3,10];		D41_Regen = 0;	D41_Vorschau = 0.2; D41_Blitze = 0;}; //geht so, akzeptabler Nebel
						if(D41_WMod == 3)	then {D41_Nebel = [0.5, 0.1,15];	D41_RegenCounter = 0; D41_Blitze = 0;}; //Dicht
						if(D41_WMod == 4)	then {D41_Nebel = [0.5, 0.1,15];	D41_Regen = 0;	D41_Vorschau = 0.4; D41_Blitze = 0;};
						if(D41_WMod == 5)	then {D41_Nebel = [0.5, 0.1,15];	D41_RegenCounter = 0; D41_Blitze = 0;}; //geht so, akzeptabler Nebel
						if(D41_WMod == 6)	then {D41_Nebel = [0.5, 0.1,30];	D41_RegenCounter = 0; D41_Blitze = 0;};
