...
if (BTC_active_lift == 1) then
{
	...
	BTC_get_liftable_array =
	{
		...
		switch (typeOf _chopper) do
		{
			...
			//UH80
			case "B_Heli_Transport_01_F" 		: {_array = ["Motorcycle","ReammoBox","ReammoBox_F","Strategic","StaticWeapon","Car","Air","Ship"];};
			//CH49
			case "I_Heli_Transport_02_F" 		: {_array = ["Motorcycle","ReammoBox","ReammoBox_F","Strategic","StaticWeapon","Car","Air","Ship"];};
