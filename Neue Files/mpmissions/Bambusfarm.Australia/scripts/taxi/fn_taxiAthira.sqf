...
switch (_ziel) do
{
	case "Kavala": {_cash = 12000; _time1 = (2*60); _time2 = (3 * 60);};
	case "Airport": {_cash = 2100; _time1 = (2*60); _time2 = (1 * 60);};
	case "Pyrgos": {_cash = 6900; _time1 = (2*60); _time2 = (2 * 60);};
	case "Sofia": {_cash = 12000; _time1 = (2*60); _time2 = (3 * 60);};
