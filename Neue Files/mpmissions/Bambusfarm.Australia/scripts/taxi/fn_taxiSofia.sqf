...
switch (_ziel) do
{
	case "Athira": {_cash = 12000; _time1 = (2*60); _time2 = (3 * 60);};
	case "Airport": {_cash = 12200; _time1 = (2*60); _time2 = (3 * 60);};
	case "Pyrgos": {_cash = 12800; _time1 = (2*60); _time2 = (3 * 60);};
	case "Kavala": {_cash = 23800; _time1 = (2*60); _time2 = (3 * 60);};
