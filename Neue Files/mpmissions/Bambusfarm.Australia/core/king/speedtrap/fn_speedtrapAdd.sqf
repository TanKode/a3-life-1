...
if(!isNull king_speedtrap) exitWith {hint "Du stellst doch schon einen Blitzer auf... nach 1 kommt 2... man man man";};
...
life_action_speedtrapDeploy = player addAction["<t color='#FF0000'>Platziere Blitzer</t>",{if(!isNull king_speedtrap) then {detach king_speedtrap; king_speedtrap = ObjNull;}; player removeAction life_action_speedtrapDeploy; life_action_speedtrapDeploy = nil;},"",999,false,false,"",'!isNull king_speedtrap'];
