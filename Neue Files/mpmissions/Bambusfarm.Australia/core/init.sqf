...
// Deckt alle Objekte auf um Sie anvisieren zu können
0 cutText["Missionsobjekte werden dem Spieler zugeordnet","BLACK FADED"];
0 cutFadeOut 9999999;
_loaded = false;
{player reveal _x} foreach (allmissionObjects "");
_loaded = true;
waitUntil{_loaded};
