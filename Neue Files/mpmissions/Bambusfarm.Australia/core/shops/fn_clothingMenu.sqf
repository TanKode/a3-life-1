...
//Cop / Civ Pre Check
if((SEL(_this,3) in ["bruce","dive","reb","kart","airsoft"] && playerSide != civilian)) exitWith {hint localize "STR_Shop_NotaCiv"; closeDialog 0;};
...
if((SEL(_this,3) in ["med"] && playerSide != independent)) exitWith {hint "Sie können diesen Shop nur als Saniteater benutzen!"; closeDialog 0;};
if((SEL(_this,3) in ["adac"] && playerSide != east)) exitWith {hint "Sie können diesen Shop nur als ADAC-Mitarbeiter benutzen!"; closeDialog 0;};
