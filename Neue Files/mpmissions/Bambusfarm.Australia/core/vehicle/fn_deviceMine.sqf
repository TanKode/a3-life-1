...
_resourceZones = ["apple_1","apple_2","apple_3","apple_4","peaches_1","peaches_2","peaches_3","peaches_4","banane_1","banane_2","banane_3","banane_4","birne_1","birne_2","birne_3","birne_4","cerises_1","cerises_2","cerises_3","cerises_4","grape_1","grape_2","heroin_1","cocaine_1","weed_1","meth_1","frogs_1","lead_1","iron_1","salt_1","sand_1","diamond_1"/*,"oil_1","oil_2"*/,"rock_1","uran_1","silber_1","gold_1","rye_1","hops_1","yeast_1"];
_zone = "";
...
_item = switch(true) do {
	...
	case (_zone in ["grape_1","grape_2"]): {"grape"};
	...
	case (_zone in ["uran_1"]): {"uran_unprocessed"};
	case (_zone in ["silber_1"]): {"silber_unprocessed"};
	case (_zone in ["gold_1"]): {"gold_unprocessed"};
