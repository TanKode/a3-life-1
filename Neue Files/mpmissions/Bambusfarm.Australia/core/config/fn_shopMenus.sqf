...
switch (_shop) do
{
	case "reb":
	{
		ctrlSetText[2505,"Australia Rebel Shop"];
		ctrlShow[2503,false];
		ctrlShow[2513,false];
		ctrlShow[2514,false];
	};
	...
	case "taxi":
	{
		ctrlSetText[2505,"Australia Taxi Shop"];
		ctrlShow[2503,false];
		ctrlShow[2513,false];
		ctrlShow[2514,false];
	};
	...
	case "cop":
	{
		ctrlSetText[2505,"Australia Cop Shop"];
		ctrlShow[2503,false];
	};
	
	case "gun":
	{
		ctrlSetText[2505,"Australia Gun Store"];
		ctrlShow[2503,false];
		ctrlShow[2513,false];
		ctrlShow[2514,false];
	};
	...
	case "dive":
	{
		ctrlSetText[2505,"Australia Diving Shop"];
		ctrlShow[2503,false];
		ctrlShow[2510,false];
		ctrlShow[2511,false];
		ctrlShow[2513,false];
	...
	case "gen":
	{
		ctrlSetText[2505,"Australia General Store"];
		ctrlShow[2503,false];
	};
