class life_skillMenu {
	...
	class controls {
		...
		class SkillInfo: Life_RscStructuredText
		{
			...
			text = "Waehlen Sie aus der Liste links ein Talent aus, fuer weitere Informationen uber die Anforderungen und die Vorteile durch deses Talent. Sie muessen min. 1 freien Skillpunkt besitzen. Momentan erhalten Sie neue Skillpunkte bei einem Level Aufstieg!"; //--- ToDo: Localize;
		...
		{
			idc = 170004;
			text = "Erlernen"; //--- ToDo: Localize;
			
			onButtonClick = "[] spawn life_fnc_skillLern";
			x = 0.314403 * safezoneW + safezoneX;
