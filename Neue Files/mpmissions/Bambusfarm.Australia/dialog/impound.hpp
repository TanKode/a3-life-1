...
class Life_impound_menu_abschlepp
{
	idd = 8800;
	name="life_vehicle_shop_2";
	movingEnabled = 0;
	enableSimulation = 1;
	onLoad = "ctrlShow [8330,false];";
	...
	class controlsBackground
	{
		...
		{
			idc = -1;
			text = "$STR_Global_BuyOut";
			onButtonClick = "[] call life_fnc_unimpoundAbschlepp;";
			x = 0.1 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH));
			y = 0.9 - (1 / 25);
			w = (6.25 / 40);
			h = (1 / 25);
	...
	class controls
	{
		class VehicleList : Life_RscListBox
		{
			...
			colorBackground[] = {0.1,0.1,0.1,0.9};
			//onLBSelChanged = "_this call life_fnc_garageLBChange;";
			onLBSelChanged = "_this call life_fnc_garageLBChangeAbschlepp;";
